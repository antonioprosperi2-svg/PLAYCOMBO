<footer>
    <div class="footer-content">
        <p>&copy; <?php echo date('Y'); ?> Play Combo - Tutti i diritti riservati.</p>
...
<style>
    footer {
        ...
        font-size: 14px;
        color: #a0a0a0;
        margin-top: 50px; /* Spinge il footer in basso se c'è poco testo */
    }
    .footer-content {
        max-width: 1200px;
        margin: 0 auto;
...
const EAGER_COUNT = 4;                 // poche immagini caricate subito
